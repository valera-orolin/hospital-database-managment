    ...
    <div class="container mx-auto px-4">
        <div class="bg-white shadow-md rounded my-6">
            ...
            <div class="px-12 pb-10">
                <div class="text-center text-5xl mb-8 font-bold">Rooms</div>

                <!-- Filter and sort form -->
                <form action="/controllers/rooms/index.php" method="get" class="mb-4">
                    <div class="space-y-2">
                        Filter by
                        <input type="text" name="roomnumber" placeholder="Room Number" class="border rounded px-3 py-2 mr-2">
                        <input type="text" name="roomtype" placeholder="Room Type" class="border rounded px-3 py-2 mr-2">
                        <input type="text" name="block" placeholder="Block" class="border rounded px-3 py-2 mr-2">
                        <input type="text" name="isavailable" placeholder="Is Available" class="border rounded px-3 py-2 mr-2">
                    </div>
                ...
                <!-- Create form -->
                <form action="/controllers/rooms/store.php" method="post" class="mb-4">
                    <div class="space-y-2">
                        <input type="text" name="roomnumber" placeholder="Room Number" class="border rounded px-3 py-2 mr-2">
                        <input type="text" name="roomtype" placeholder="Room Type" class="border rounded px-3 py-2 mr-2">
                        <input type="text" name="block" placeholder="Block" class="border rounded px-3 py-2 mr-2">
                            ...
                            @foreach ($rooms as $room)
                                <tr class="border-b hover:bg-orange-100">
                                    ...
                                    <td class="text-red-500 p-3 px-5">
                                        <form id="delete-form" action="/controllers/rooms/destroy.php" method="post" onsubmit="return confirm('Are you sure you want to delete this record?');">
