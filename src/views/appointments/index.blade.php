    ...
    <div class="container mx-auto px-4">
        <div class="bg-white shadow-md rounded my-6">
            ...
            <div class="px-12 pb-10">
                <div class="text-center text-5xl mb-8 font-bold">Appointments</div>

                <form action="/controllers/appointments/index.php" method="get" class="mb-4">
                    <div class="space-y-2">
                        Filter by
                ...
                <!-- Create form -->
                <form action="/controllers/appointments/store.php" method="post" class="mb-4">
                    <div class="space-y-2">
                        <input type="text" name="patient" placeholder="Patient" class="border rounded px-3 py-2 mr-2">
                        <input type="text" name="doctor" placeholder="Doctor" class="border rounded px-3 py-2 mr-2">
                        <input type="text" name="nurse" placeholder="Nurse" class="border rounded px-3 py-2 mr-2">
                        <input type="text" name="examinationroom" placeholder="Examination Room" class="border rounded px-3 py-2 mr-2">
                            ...
                            @foreach ($appointments as $appointment)
                                <tr class="border-b hover:bg-orange-100">
                                    ...
                                    <td class="text-red-500 p-3 px-5">
                                        <form id="delete-form" action="/controllers/appointments/destroy.php" method="post" onsubmit="return confirm('Are you sure you want to delete this record?');">
                                ...
                                <tr class="border-b hidden">
                                    <form id="edit-form-{{ $appointment['appointmentid'] }}" action="/controllers/appointments/update.php" method="post">
                                        @foreach ($appointment as $key => $value)
                                            @if (strpos($key, 'link-') === 0)
                                                <td class="p-3 px-5"></td>
                                            @elseif ($key != 'appointmentid')
                                                <td class="p-3 px-5">
