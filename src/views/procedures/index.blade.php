    ...
    <div class="container mx-auto px-4">
        <div class="bg-white shadow-md rounded my-6">
            ...
            <div class="px-12 pb-10">
                <div class="text-center text-5xl mb-8 font-bold">Procedures</div>

                <!-- Filter and sort form -->
                <form action="/controllers/procedures/index.php" method="get" class="mb-4">
                    <div class="space-y-2">
                        Filter by
                        ...
                        <input type="text" name="cost" placeholder="Cost" class="border rounded px-3 py-2 mr-2">
                    </div>
                ...
                <!-- Create form -->
                <form action="/controllers/procedures/store.php" method="post" class="mb-4">
                    <div class="space-y-2">
                        <input type="text" name="code" placeholder="Code" class="border rounded px-3 py-2 mr-2">
                        <input type="text" name="name" placeholder="Name" class="border rounded px-3 py-2 mr-2">
                        <input type="text" name="cost" placeholder="Cost" class="border rounded px-3 py-2 mr-2">
                ...
                <div class="overflow-x-auto w-full">
                    <table class="w-full text-md bg-white shadow-md rounded mb-4">
                        <thead>
                            <tr class="border-b">
                                @if (isset($procedures[0]))
                                    @foreach ($procedures[0] as $key => $value)
                            ...
                            @foreach ($procedures as $procedure)
                                <tr class="border-b hover:bg-orange-100">
                                    ...
                                    <td class="text-red-500 p-3 px-5">
                                        <form id="delete-form" action="/controllers/procedures/destroy.php" method="post" onsubmit="return confirm('Are you sure you want to delete this record?');">
                                ...
                                <tr class="border-b hidden">
                                    <form id="edit-form" action="/controllers/procedures/update.php" method="post">
