    ...
    <div class="container mx-auto px-4">
        <div class="bg-white shadow-md rounded my-6">
            ...
            <div class="px-12 pb-10">
                <div class="text-center text-5xl mb-8 font-bold">Payments</div>

                <form action="/controllers/payments/index.php" method="get" class="mb-4">
                    <div class="space-y-2">
                        Filter by
                        <input type="text" name="bill" placeholder="Bill" class="border rounded px-3 py-2 mr-2">
                        <input type="text" name="amount" placeholder="Amount" class="border rounded px-3 py-2 mr-2">
                        <input type="date" name="date_paid" placeholder="Date Paid" class="border rounded px-3 py-2 mr-2">
                    </div>
                ...
                <!-- Create form -->
                <form action="/controllers/payments/store.php" method="post" class="mb-4">
                    <div class="space-y-2">
                        <input type="text" name="bill" placeholder="Bill" class="border rounded px-3 py-2 mr-2">
                        <input type="text" name="amount" placeholder="Amount" class="border rounded px-3 py-2 mr-2">
                        <input type="date" name="date_paid" placeholder="Date Paid" class="border rounded px-3 py-2 mr-2">
                            ...
                            @foreach ($payments as $payment)
                                <tr class="border-b hover:bg-orange-100">
                                    ...
                                    <td class="text-red-500 p-3 px-5">
                                        <form id="delete-form-{{ $payment['paymentid'] }}" action="/controllers/payments/destroy.php" method="post" onsubmit="return confirm('Are you sure you want to delete this record?');">
                                ...
                                <tr class="border-b hidden">
                                    <form id="edit-form-{{ $payment['paymentid'] }}" action="/controllers/payments/update.php" method="post">
