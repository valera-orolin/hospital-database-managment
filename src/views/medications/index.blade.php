    ...
    <div class="container mx-auto px-4">
        <div class="bg-white shadow-md rounded my-6">
            ...
            <div class="px-12 pb-10">
                <div class="text-center text-5xl mb-8 font-bold">Medications</div>

                <!-- Filter and sort form -->
                <form action="/controllers/medications/index.php" method="get" class="mb-4">
                    <div class="space-y-2">
                        Filter by
                        <input type="text" name="code" placeholder="Code" class="border rounded px-3 py-2 mr-2">
                        <input type="text" name="name" placeholder="Name" class="border rounded px-3 py-2 mr-2">
                        <input type="text" name="brand" placeholder="Brand" class="border rounded px-3 py-2 mr-2">
                ...
                <!-- Create form -->
                <form action="/controllers/medications/store.php" method="post" class="mb-4">
                    <div class="space-y-2">
                        <input type="text" name="code" placeholder="Code" class="border rounded px-3 py-2 mr-2">
                        <input type="text" name="name" placeholder="Name" class="border rounded px-3 py-2 mr-2">
                        <input type="text" name="brand" placeholder="Brand" class="border rounded px-3 py-2 mr-2">
                        ...
                        <thead>
                            <tr class="border-b">
                                @if (isset($medications[0]))
                                    @foreach ($medications[0] as $key => $value)
                            ...
                            @foreach ($medications as $medication)
                                <tr class="border-b hover:bg-orange-100">
                                    ...
                                    <td class="text-red-500 p-3 px-5">
                                        <form id="delete-form" action="/controllers/medications/destroy.php" method="post" onsubmit="return confirm('Are you sure you want to delete this record?');">
